...
| <a name="input_enable_maintenance_window"></a> [enable\_maintenance\_window](#input\_enable\_maintenance\_window)                                               | Enable maintenance for AKS cluster                                                                                                                                                                                                                 | `bool`                                                                              | `false`                     |    no    |
...
| <a name="input_maintenance_allowed"></a> [maintenance\_allowed](#input\_maintenance\_allowed)                                                                   | Days and hours when maintenance is allowed                                                                                                                                                                                                         | <pre>list(object({<br>    day   = string<br>    hours = list(number)<br>  }))</pre> | `[]`                        |    no    |
| <a name="input_maintenance_not_allowed"></a> [maintenance\_not\_allowed](#input\_maintenance\_not\_allowed)                                                     | Days and hours when maintenance is not allowed                                                                                                                                                                                                     | <pre>list(object({<br>    end   = string<br>    start = string<br>  }))</pre>       | `[]`                        |    no    |
